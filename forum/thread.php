...
<body>
   ...
   ?>
    ...
    <?php
        $thread_id=$_GET['threadid']; //which we pass in the url
    ...
    <?php
        ...
        echo '<div class="container my-3">
                <div class="jumbotron">
                    <h5 class="display-4" style="font-size: 2.5rem;">'. $thread_title.'</h5>
                    ...
                    <hr>
                    <p><b>Posted By:-'.$thread_user_name.'</b></p>
        ...
        <?php
            ...
            while($row=mysqli_fetch_assoc($result)){
                ...
                <div class="media my-3">
                    ...
                    <p class="font-weight-bold my-0">Posted By:- '.$comment_user_name. ', '.$comment_time.'</p>
                </div>';
            }
            if($noResult){
